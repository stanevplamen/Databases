...
namespace MondoWay
{
    class MainDemo
    {
        ...
        public static string ConnectionCollection = "Dictionary";
        public static string ConnectionDatabase = "Words";

        private static MongoDictionary demoDic;

        static void Main()
        {
            demoDic = new MongoDictionary();
            AddWords();
            Console.WriteLine("List All Words");
            demoDic.ListAllWords();
            TranslateSomeWords(new List<string>() { "Bird", "Fish", "Woman", "Man" });
            RemoveWords(new List<string>() { "Fish", "Woman", "Man" });
